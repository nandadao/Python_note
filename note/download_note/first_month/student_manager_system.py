"""
	...
	六）输出学生__output_students
	   删除学生__delete_student

	七）修改学生信息__modify_student
	   根据成绩升序显示学生__output_students_by_score
...
# 二） 删除学生def remove_student(stu_id)
...
# 根据成绩排序 order_by_score()
manager.add_student(StudentModel("唐僧1", 25, 100))
manager.add_student(StudentModel("唐僧2", 25, 75))
