...
# https://aip.baidubce.com/rest/2.0/image-classify/v1/plant  application/x-www-form-urlencoded
# https://aip.baidubce.com/rest/2.0/image-classify/v2/advanced_general  application/x-www-form-urlencoded
